...
```bash
git clone https://github.com/kim62210/damn-my-slow-lg.git
cd damn-my-slow-lg
npm install          # 자동으로 TypeScript 빌드까지 실행됨
npm link             # 글로벌 CLI 심볼릭 링크 등록
npx playwright install chromium
```

> AI 에이전트 개발 환경 설정은 [README.ai-ready.md](./README.ai-ready.md)를 참고하세요.
